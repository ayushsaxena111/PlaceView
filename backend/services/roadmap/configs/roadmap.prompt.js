...
Your task is to generate a highly personalized learning roadmap that helps a user achieve their target role and salary.
...
8. Use relevant and current industry practices while planning the roadmap.
9. Each module should naturally depend on the previous modules.
10. Generate between 8 and 15 modules.
11. Keep each module description concise (2-3 lines).
...
19. Ensure all required JSON fields are present.
20. Ensure the JSON is syntactically valid and can be parsed directly using JSON.parse().
21. Do NOT use trailing commas.
22. Do NOT wrap the JSON inside a markdown code block.
...
Never return lowercase values for difficulty or level.
`;
